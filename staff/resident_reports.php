...
|--------------------------------------------------------------------------
|
| This page provides reports based on registered resident information.
|
| Confirmed resident fields used:
| - resident_number
| - first_name
| - middle_name
| - last_name
...
<div class="card">
    ...
    >
        ...
        <div
            class="resident-reports-actions"
        >
                ...
                <?php foreach (
                    ...
                    <option
                        ...
                        <?= $occupation_filter === $occupation
                            ...
                            : "" ?>
                    >
                        <?= resident_report_escape($occupation) ?>
                    </option>
    ...
    >
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                style="width: <?= number_format($bar_width, 2, ".", "") ?>%;"
                            ></div>
        ...
        >
            ...
            >
                ...
                <p>
                    Top 10 addresses with the highest number of registered residents.
                </p>
            ...
            >
                ...
                <?php if (
                    ...
                    <?php foreach (
                        ...
                        <div
                            class="report-bar-row"
                            style="grid-template-columns: 220px minmax(0, 1fr) 55px;"
                        >
