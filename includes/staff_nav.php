...
<div class="sidebar<?= isset($no_print_nav) && $no_print_nav ? " no-print" : "" ?>">
    ...
    <nav class="sidebar-links">
        ...
        <a class="<?= trim(
            nav_active("resident_management.php", $current_page) .
            nav_active("register.php", $current_page) .
            nav_active("resident_view.php", $current_page) .
            nav_active("resident_edit.php", $current_page) .
            nav_active("updated_records.php", $current_page)
        ) ?>" href="resident_management.php" title="Resident Management">
